...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-black text-white dark:text-white mt-40 lg:mt-20 ">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
					<img src="https://i.ibb.co/sH6v1hg/4112864-removebg-preview.png" alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">TrickTrove</span>
			</a>
		</div>
