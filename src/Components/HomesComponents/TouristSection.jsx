    ...
    return (
        <div>
           ...
           <h1 className=" text-center font1 text-xl md:text-4xl lg:text-5xl xl:7xl font-extrabold">Our Destinations</h1>
            <p className="lg:w-[750px] mx-auto text-center font2 mt-2 font-semibold text-lg text-gray-600">Our Destinations: Exploring the Wonders of the World, From Majestic Mountains to Pristine Beaches. Uncover Hidden Gems and Create Memories That Last a Lifetime.</p>
           </div>
