...
const TouristSection = ({places}) => {
    ...
    return (
        <div>
           <div>
           <h1 className=" text-center font1 text-xl md:text-2xl lg:text-5xl xl:7xl font-extrabold">Our Destinations</h1>
           ...
           <div className='grid grid-cols-1 lg:grid-cols-3 gap-10 mx-auto lg:px-10 mt-20'>
            {
